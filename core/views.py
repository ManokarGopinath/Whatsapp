...
from .forms import WhatsappForm, FilmForm, LocationChoiceField, LabelChoiceField, DateChoiceField, UploadFileForm
        ...
        if form.is_valid():
            ...
            if option == 'single':
                ...
                try:
                    ...
                    df.to_csv(dot + 'media/data.csv', index=False)
                    print('ok')
                    inputcsvfilename = dot + 'media/data.csv'
                    ...
                    new_df.to_csv('media/modified_data.csv', index=False)
                    df = pd.read_csv('media/modified_data.csv')
...
class Leads_view(View):
    ...
    def get(self,  request):
        ...
        #     writer.writerow(['Film Name', 'Year', 'Film URL', 'Dropdown List', 'Check Status'])

        #     for film in details:
        #         writer.writerow([film.date, film.year, film.filmurl, film.dropdownlist, film.checkstatus])
